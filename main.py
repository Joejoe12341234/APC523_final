...
parser.add_argument('--flow_speed')
parser.add_argument('--viscosity')
parser.add_argument('--CFL')
parser.add_argument('--model_time')
parser.add_argument('--timestep_method')
parser.add_argument('--spatial_discretization')
...
run_model(N, U, nu, cfl, runtime, timestep_method, spatial_method, visualize)